/**
 * SSE-X token derivation — `@cuilabs/qnsp/llamaindex` subpath.
 *
 * Faithful inline of the SSE-X token-derivation crypto from the former
 * `@cuilabs/qnsp-search-sdk` `sse.ts` (2026-05-16 consolidation). Only the
 ...
 * subpath avoid a `@cuilabs/qnsp-shared-kernel` dependency. Crypto is
