...
> **Note** — As of 2026-04-30, the per-service `@qnsp/billing-sdk` package is consolidated into the unified `@cuilabs/qnsp` SDK (one package per language). New integrations should use:
>
> ```typescript
